...
{html_options id='industry_advanced' name='industry_advanced[]' options=$fields.industry_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.industry_advanced.value}
   	   	</td>
