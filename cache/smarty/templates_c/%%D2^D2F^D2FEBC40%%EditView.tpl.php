<?php /* Smarty version 2.6.11, created on 2014-06-02 11:23:50
         compiled from cache/modules/Leads/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Leads/EditView.tpl', 48, false),array('function', 'counter', 'cache/modules/Leads/EditView.tpl', 54, false),array('function', 'sugar_getimagepath', 'cache/modules/Leads/EditView.tpl', 57, false),array('function', 'sugar_translate', 'cache/modules/Leads/EditView.tpl', 60, false),array('function', 'html_options', 'cache/modules/Leads/EditView.tpl', 77, false),array('function', 'sugar_getjspath', 'cache/modules/Leads/EditView.tpl', 249, false),array('modifier', 'default', 'cache/modules/Leads/EditView.tpl', 53, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/EditView.tpl', 71, false),array('modifier', 'lookup', 'cache/modules/Leads/EditView.tpl', 479, false),array('modifier', 'count', 'cache/modules/Leads/EditView.tpl', 559, false),)), $this); ?>
...
<input accesskey=""  tabindex="0"  name="account_name" id="EditView_account_name" <?php if (( $this->_tpl_vars['fields']['converted']['value'] == 1 )): ?>disabled="true"<?php endif; ?> size="30" maxlength="255" type="text" value="<?php echo $this->_tpl_vars['fields']['account_name']['value']; ?>
">
...
<tr>
<td id="primary_address_street_label" width='%' scope='row' >
<label for="primary_address_street"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STREET','module' => ''), $this);?>
:</label>
</td>
<td>
...
<label for="primary_address_city"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => ''), $this);?>
:</label>
</td>
<td>
<input type="text" name="primary_address_city" id="primary_address_city" size="30" maxlength="100" value='<?php echo $this->_tpl_vars['fields']['primary_address_city']['value']; ?>
' tabindex="0">
</td>
</tr>
<tr>
<td id="primary_address_state_label" width='%' scope='row' >
<label for="primary_address_state"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_STATE','module' => ''), $this);?>
:</label>
</td>
<td>
<input type="text" name="primary_address_state" id="primary_address_state" size="30" maxlength="100" value='<?php echo $this->_tpl_vars['fields']['primary_address_state']['value']; ?>
' tabindex="0">
</td>
</tr>
<tr>
<td id="primary_address_postalcode_label" width='%' scope='row' >
<label for="primary_address_postalcode"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_POSTALCODE','module' => ''), $this);?>
:</label>
</td>
<td>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30" maxlength="20" value='<?php echo $this->_tpl_vars['fields']['primary_address_postalcode']['value']; ?>
' tabindex="0">
</td>
</tr>
<tr>
<td id="primary_address_country_label" width='%' scope='row' >
<label for="primary_address_country"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_COUNTRY','module' => ''), $this);?>
:</label>
</td>
<td>
...
<label for="alt_address_street"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_STREET','module' => ''), $this);?>
:</label>
</td>
<td>
...
<label for="alt_address_city"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_CITY','module' => ''), $this);?>
:</label>
</td>
<td>
<input type="text" name="alt_address_city" id="alt_address_city" size="30" maxlength="100" value='<?php echo $this->_tpl_vars['fields']['alt_address_city']['value']; ?>
' tabindex="0">
</td>
</tr>
<tr>
<td id="alt_address_state_label" width='%' scope='row' >
<label for="alt_address_state"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_STATE','module' => ''), $this);?>
:</label>
</td>
<td>
<input type="text" name="alt_address_state" id="alt_address_state" size="30" maxlength="100" value='<?php echo $this->_tpl_vars['fields']['alt_address_state']['value']; ?>
' tabindex="0">
</td>
</tr>
<tr>
<td id="alt_address_postalcode_label" width='%' scope='row' >
<label for="alt_address_postalcode"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_POSTALCODE','module' => ''), $this);?>
:</label>
</td>
<td>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30" maxlength="20" value='<?php echo $this->_tpl_vars['fields']['alt_address_postalcode']['value']; ?>
' tabindex="0">
</td>
</tr>
<tr>
<td id="alt_address_country_label" width='%' scope='row' >
<label for="alt_address_country"><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS_COUNTRY','module' => ''), $this);?>
:</label>
</td>
<td>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='opportunity_amount_label' width='12.5%' scope="col">
...
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Leads','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'first_name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'Leads','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'phone_mobile\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_PHONE','module' => 'Leads','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'email1\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'Leads','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'lead_source\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'Leads','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'account_name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NAME','module' => 'Leads','for_js' => true), $this); echo '\' );
