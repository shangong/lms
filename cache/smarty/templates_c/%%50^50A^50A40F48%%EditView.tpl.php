<?php /* Smarty version 2.6.11, created on 2014-06-13 08:30:42
         compiled from cache/modules/Opportunities/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Opportunities/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/Opportunities/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/modules/Opportunities/EditView.tpl', 56, false),array('function', 'sugar_getimagepath', 'cache/modules/Opportunities/EditView.tpl', 100, false),array('function', 'sugar_getimage', 'cache/modules/Opportunities/EditView.tpl', 141, false),array('function', 'sugar_number_format', 'cache/modules/Opportunities/EditView.tpl', 182, false),array('function', 'html_options', 'cache/modules/Opportunities/EditView.tpl', 199, false),array('modifier', 'strip_semicolon', 'cache/modules/Opportunities/EditView.tpl', 57, false),array('modifier', 'default', 'cache/modules/Opportunities/EditView.tpl', 152, false),array('modifier', 'lookup', 'cache/modules/Opportunities/EditView.tpl', 224, false),array('modifier', 'count', 'cache/modules/Opportunities/EditView.tpl', 304, false),)), $this); ?>
...
<td valign="top" id='date_closed_label' width='12.5%' scope="col">
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['opportunity_type']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['opportunity_type']['name'];  echo ' = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['opportunity_type']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['opportunity_type']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='probability_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='next_step_label' width='12.5%' scope="col">
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITY_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'opportunity_type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'account_name\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'account_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'campaign_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'campaign_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'lead_source\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'amount\', \'currency\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'amount_usdollar\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT_USDOLLAR','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'currency_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'currency_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'currency_symbol\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY_SYMBOL','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_closed\', \'date\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_CLOSED','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'next_step\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NEXT_STEP','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'sales_stage\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SALES_STAGE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidateRange(\'EditView\', \'probability\', \'int\', false, \'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PROBABILITY','module' => 'Opportunities','for_js' => true), $this); echo '\', 0, 100);
...
addToValidateBinaryDependency(\'EditView\', \'account_name\', \'alpha\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Opportunities','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\', \'account_id\' );
addToValidateBinaryDependency(\'EditView\', \'campaign_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Opportunities','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN','module' => 'Opportunities','for_js' => true), $this); echo '\', \'campaign_id\' );
